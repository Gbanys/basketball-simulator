...
def train_layup_model():
    ...
    layup_dataframe['shot_made_overall'] = layup_dataframe[['shot_made_by_ability', 'shot_made_by_energy']]\
    ...
    input_features = layup_dataframe[['scaled_player_ability', 'scaled_player_energy']]
